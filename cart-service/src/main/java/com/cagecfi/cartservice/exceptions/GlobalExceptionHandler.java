...
public class GlobalExceptionHandler {
    ...
    public @ResponseBody ProblemDetail handle(CartNotFoundException ex) {
    ...
    @ExceptionHandler(value = CartLineNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public @ResponseBody ProblemDetail handle(CartLineNotFoundException ex) {
        ProblemDetail problemDetail = ProblemDetail.forStatus(HttpStatus.NOT_FOUND);
